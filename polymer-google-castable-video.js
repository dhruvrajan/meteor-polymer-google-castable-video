...
// Wrap every asynchronus bower command with `Meteor._wrapAsync`
  ...
  if (!_.contains(localCache, 'GoogleWebComponents/google-castable-video#^1.0.0')){
    console.log('installing polymer and google-castable-video' +
        ' into public directory...');
    //console.log(localCache);
    Bower.install(['GoogleWebComponents/google-castable-video#^1.0.0'], {save: true}, {directory: dir});
  } else {
    console.log("google-castable-video exists already. To reinitialize, remove bower_components from your public/ folder");
  }
}